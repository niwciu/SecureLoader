...
It requires that the target device is already running a compatible bootloader (e.g. [**SecureBootloader**](https://github.com/niwciu/SECURE_BOOTLOADER)).
...
Related repositories: [SecureBootloader](https://github.com/niwciu/SECURE_BOOTLOADER) · [EncryptBIN](https://github.com/niwciu/EncryptBIN)
...
⚠️ The target device must already be flashed with [**SecureBootloader**](https://github.com/niwciu/SECURE_BOOTLOADER) before SecureLoader can be used.
